...
CALL mvn org.apache.maven.plugins:maven-dependency-plugin:get -DrepoUrl=https://oss.sonatype.org/content/repositories/snapshots -Dartifact=io.cresco:wsapi:1.1-SNAPSHOT
...
copy /Y %systemdrive%%homepath%\.m2\repository\io\cresco\wsapi\1.1-SNAPSHOT\wsapi-1.1-SNAPSHOT.jar src\main\resources\